        ...
        while pila:
            ...
            if not visitados[nodo_actual]:
                ...
                for adyacente in self.adyacentes(nodo_actual):
                    if not visitados[adyacente] and v in self.adyacentes(adyacente):
                        pila.append((adyacente, camino + [adyacente]))
                """for vecino in range(self.__elementos):
                    if self.__matriz_adyacencia[nodo_actual][vecino] == 1 and not visitados[vecino]:
...
if __name__ == '__main__':
    grafo = Grafo(5)
    lista = [ (0, 0), (1, 2), (3, 3), (1, 3), (0, 4), (1, 4), (2, 3), (2, 1), (3, 1), (4, 0), (4, 1), (3, 2)]
    for u,v in lista:
